 ...
 *     &lt;enumeration value="VATSystemMixed"/>
...
public enum TypeFeatureSetEnum {
    ...
    PROJECT("Project"),
    VAT("VAT"),
    @XmlEnumValue("VATSystemMixed")
    VAT_SYSTEM_MIXED("VATSystemMixed"),
    ...
    INVENTORY("Inventory"),
    @XmlEnumValue("ChequesOld")
    CHEQUES_OLD("ChequesOld"),
